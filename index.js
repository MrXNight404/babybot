...
console.log(banner.string)
   ...
   qrcode.generate(qr, { small: true })
	console.log(color('[','white'), color('!','red'), color(']','white'), color(' SUBSCRIBE YT Gabuts Zall'))
})
...
*/
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					setTimeout( () => {
					baby.sendMessage(from, caklontong, text, {quoted: mek})ýýý
					}, 0) // 1000 = 1s,
					await limitAdd(sender) 
					break 
				case 'tebakin':

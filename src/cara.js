...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp Zall MCA
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo Rizal
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig hello_zalll_04
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & Rizal
➸ *${prefix}play*
...
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub Rizal & Hub
